# 🧠 CLAUDE.md Master Prompt — The Ultimate Meta Guide for AI Coding Assistants

[![Prompt Engineering](https://img.shields.io/badge/Prompt-Engineering-blueviolet)](https://github.com/nordeim/claude-md-meta-prompt)
[![For Claude AI](https://img.shields.io/badge/Claude-AI-ffd700)](https://claude.ai/)
[![Universal Codebase](https://img.shields.io/badge/Universal-Codebase-green)](#)
...
**Welcome to the CLAUDE.md Master Prompt Project!**

This repository provides a meticulously crafted meta-prompt that enables Claude Code (claude.ai/code) and other AI coding assistants to instantly understand, navigate, and work productively with any codebase. By generating a standardized, comprehensive `CLAUDE.md` file, you empower your AI assistant to deliver world-class code insights, onboarding, and productivity—no matter the project.

---

## ✨ Why Use This Prompt?

- **Supercharged AI Onboarding:** Claude instantly knows your project structure, key files, setup, and conventions.
- **Universal Compatibility:** Works for any language, framework, or domain.
- **Actionable & Structured:** Ensures your AI assistant gets context, commands, and architectural guidance in one place.
- **Boosts Collaboration:** Developers, AI agents, and contributors benefit from a clear project meta-guide.

---

## 📋 Quick Start

Copy and paste the following master prompt to **Claude** (or use it as a template for your own AI onboarding docs):
